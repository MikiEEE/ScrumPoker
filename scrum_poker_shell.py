...
class ScrumPokerShell(BaseShell):
    ...
    def _register_builtin_commands(self):
        ...
        self._register_command(
            "poker",
            self.command_poker,
            "Manage mounted scrum poker apps. Usage: poker apps | poker <app_id> session|idle|clear ...",
            aliases=("scrum",),
        )
    ...
    def command_poker(self, args):
        ...
        raise ShellCommandError("usage: poker apps | poker <app_id> session|idle|clear ...")
